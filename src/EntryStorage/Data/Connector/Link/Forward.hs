module EntryStorage.Data.Connector.Link.Forward
( Type ) where
...
instance Serializable.Interface Type where
    ...
    deserialize words = 
        case Serializable.deserialize words of
            ...
            Left errorMessage -> Left $ "Error deserializing forward connector link. " ++ errorMessage
...
instance Traversable.ConnectorProducibleInterface Type where
    getConnector (Type link) = Traversable.getConnector link